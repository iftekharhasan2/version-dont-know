...
const HeroTreeSection: React.FC<HeroTreeProps> = ({ onExploreFocus, onOpenContact, onNavigateFocus, onNavigateAbout }) => {
        ...
        <div className="text-center max-w-4xl mx-auto space-y-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            ...
            <div
              ...
              className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-[#081220] border border-slate-800 hover:border-[#ff7e67]/60 text-xs text-slate-400 hover:text-slate-100 transition-colors cursor-pointer group"
              title="View IP3 Global Thinkers and Fellows on About Us"
            >
              <span className="text-slate-100 font-bold">100+</span>
              <span>Global Economists &amp; Thinkers</span>
              <ChevronRight className="w-3 h-3 text-[#ff7e67] opacity-60 group-hover:opacity-100 group-hover:translate-x-0.5 transition-all" />
            </div>
            <div className="flex items-center gap-1.5 px-3 py-1 rounded-xl bg-[#081220] border border-slate-800 text-xs text-slate-400">
          ...
          {/* Action CTA to About Us */}
          <div className="flex flex-wrap items-center justify-center gap-3 pt-3">
            <button
              id="btn-hero-tree-about"
              type="button"
              onClick={onNavigateAbout}
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-[#ff7e67] hover:bg-[#ff907d] text-[#081220] font-bold text-xs uppercase tracking-wider transition-all duration-200 shadow-lg shadow-[#ff7e67]/25 hover:shadow-[#ff7e67]/40 hover:gap-2.5 cursor-pointer group"
            >
              <span>About IP3 &amp; Our Leadership</span>
        ...
        <div className="mt-14 max-w-5xl mx-auto relative">
          ...
          <div className="flex flex-col items-center justify-center relative z-20">
            <button
              type="button"
              onClick={onNavigateAbout}
              title="Learn More About IP3 Institutional Architecture on About Us"
              className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl bg-[#081220] border-2 border-[#ff7e67]/40 text-xs font-bold text-slate-100 shadow-2xl shadow-black/80 hover:border-[#ff7e67] transition-all duration-200 group cursor-pointer text-left"
            >
              ...
              <div className="text-left">
                ...
                <span className="text-xs sm:text-sm font-extrabold text-slate-100 flex items-center gap-1.5">
                  <span>IP3 Policy Architecture Framework</span>
                  <ArrowRight className="w-3.5 h-3.5 text-[#ff7e67] group-hover:translate-x-1 transition-transform" />
                </span>
              </div>
            </button>
...
export const Ip3PolicySection: React.FC<Ip3PolicySectionProps> = ({ onNavigateFocus, onNavigateAbout }) => {
