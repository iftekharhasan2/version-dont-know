...
export const PolicyShowcaseSection: React.FC<PolicyShowcaseSectionProps> = ({
  onNavigateAbout,
}) => {
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 py-4 sm:py-8 flex flex-col justify-center gap-16 lg:gap-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            {/* Action CTA taking visitors to About Us */}
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <button
                id="btn-showcase-about"
                type="button"
                onClick={onNavigateAbout}
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-[#ff7e67] hover:bg-[#ff907d] text-[#081220] font-bold text-xs uppercase tracking-wider transition-all duration-200 shadow-lg shadow-[#ff7e67]/25 hover:shadow-[#ff7e67]/40 hover:gap-3 cursor-pointer group"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <button
                id="btn-showcase-hub-about"
                type="button"
                onClick={onNavigateAbout}
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-[#0e1b2c] hover:bg-[#16273e] text-slate-100 hover:text-white border border-slate-700/80 hover:border-[#ff7e67]/60 font-bold text-xs uppercase tracking-wider transition-all duration-200 hover:gap-3 cursor-pointer group shadow-md"
              >
                <span>Discover IP3 People &amp; Practice</span>
                <ArrowRight className="w-4 h-4 text-[#ff7e67] transition-transform group-hover:translate-x-0.5" />
              </button>
            </div>
          </motion.div>
