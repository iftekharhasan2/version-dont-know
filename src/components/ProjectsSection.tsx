...
export const ProjectsSection: React.FC<ProjectsSectionProps> = ({ embedded = false }) => {
  ...
  // Strictly 3 columns and 2 rows per page (6 cards per page)
      ...
      <div className={`${embedded ? 'w-full' : 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'} space-y-8 relative z-10`}>
        ...
        {filteredProjects.length === 0 ? (
          ...
          <div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 lg:gap-5 scroll-mt-24"
          >
            {displayedProjects.map((project) => (
              ...
              >
                {/* Image Banner */}
                <div className="relative h-40 sm:h-44 overflow-hidden bg-[#081220]">
                  <img
                ...
                <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3">
                  <div className="space-y-1.5">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-slate-100 group-hover:text-[#ff7e67] transition-colors leading-snug">
                      {project.title}
                    </h3>
