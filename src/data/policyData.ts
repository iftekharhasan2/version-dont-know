...
export const PROJECTS: ProjectItem[] = [
  ...
  {
    id: 'sovereign-digital-id',
    title: 'National Digital Identity & Civil Registry Interoperability Architecture',
    category: 'governance',
    categoryLabel: 'Digital Governance',
    partner: 'Ministry of Digital Economy & UNDP Co-op',
    partnerLogoText: 'UNDP / Gov',
    year: '2023-2025',
    location: 'Federal Administrative Zone',
    description: 'Designing an open-source, cryptographic data exchange spine connecting civil registries, taxation, and sovereign social safety net payouts with automated auditing.',
    keyOutcome: 'Reduced service delivery latency by 76% and eliminated phantom entitlement leakages across 14 million registered citizens.',
    tags: ['Digital ID', 'Public Infrastructure', 'Interoperability', 'Data Sovereignty'],
    imageUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=800',
    featured: true,
    detailedScope: 'Cryptographic schema standardization, zero-trust API boundaries, and citizen data protection governance.'
  },
  {
    id: 'curriculum-stem-reform',
    title: 'National Secondary STEM & Vocational Curriculum Modernization',
    category: 'education',
    categoryLabel: 'Education Reform',
    partner: 'Global Partnership for Education & UNESCO',
    partnerLogoText: 'UNESCO / GPE',
    year: '2022-2025',
    location: 'Regional Education Directorates',
    description: 'Comprehensive overhaul of secondary technical and vocational curricula, embedding hands-on climate engineering, computational modeling, and modular teacher accreditation.',
    keyOutcome: 'Trained 18,400 STEM educators and improved national competency assessment pass rates by 34.2% across pilot cohorts.',
    tags: ['STEM Education', 'Pedagogy', 'Teacher Training', 'Curriculum Reform'],
    imageUrl: 'https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&q=80&w=800',
    featured: true,
    detailedScope: 'Pedagogical content re-authoring, modular laboratory kits distribution, and digital assessment platform integration.'
  },
  {
    id: 'circular-manufacturing-feasibility',
    title: 'Industrial Sector Decarbonization & Circular Material Flow Audit',
    category: 'feasibility',
    categoryLabel: 'Firm Surveys',
    partner: 'National Industrial Development Corporation & IFC',
    partnerLogoText: 'IFC / NIDC',
    year: '2024',
    location: 'Special Economic Zones & Heavy Manufacturing Hubs',
    description: 'Field-level quantitative economic survey across 620 heavy industrial manufacturing plants, modeling thermal recapture feasibility and secondary raw material substitution.',
    keyOutcome: 'Identified $340M in commercially viable heat recapture investments with an average payback horizon under 3.2 years.',
    tags: ['Industrial Ecology', 'Firm Survey', 'Feasibility', 'Circular Economy'],
    imageUrl: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=800',
    featured: true,
    detailedScope: 'Plant-by-plant thermodynamic energy audits, raw material input-output accounting, and capital cost feasibility modeling.'
  },
  {
    id: 'coastal-mangrove-blue-carbon',
    title: 'Sovereign Blue Carbon Protocol & Mangrove Estuary Telemetry',
    category: 'climate',
    categoryLabel: 'Blue Carbon Science',
    partner: 'Global Ocean Council & National Environmental Authority',
    partnerLogoText: 'Ocean Council',
    year: '2023-2026',
    location: 'Estuarine Delta & Coastal Wetlands (45,000 Ha)',
    description: 'High-precision satellite radar and acoustic benthic sensor monitoring measuring soil carbon accumulation across contiguous restored coastal mangrove forests.',
    keyOutcome: 'Verified 4.6 tons CO2e/ha/yr blue carbon sequestration accredited under international sovereign biodiversity carbon credit standards.',
    tags: ['Blue Carbon', 'Mangroves', 'Wetlands', 'Satellite Radar', 'Carbon Credits'],
    imageUrl: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&q=80&w=800',
    featured: true,
    detailedScope: 'Benthic core sampling, drone lidar canopy mapping, and sovereign carbon credit registry verification.'
  }
];
